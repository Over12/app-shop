...
export default function Hero() {
  return (
    <section className="h-screen flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 p-5 lg:p-10">
      <div>
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium text-left mb-1">Bienvenido a <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">Shoplyx</span></h1>
